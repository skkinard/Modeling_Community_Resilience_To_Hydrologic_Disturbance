...
d_fish <- read_csv('exploration/output/model_combined_vars.csv') %>%
  ...
  is_baseline(end_test = "2017-08-31") # set hurricane test period limit
...
best_svm <- make_best('bstepN_SVM_poly')
best_svm_fit <- make_best_fit('bstepN_SVM_poly')
best_baseline_fit_svm <- make_best_fit_baseline('bstepN_SVM_poly')
plot_test_best_svm <- visualize_best_fit_test('bstepN_SVM_poly')
plot_EvO_density_svm <- visualize_expected_v_observed('bstepN_SVM_poly')
plot_timeseries_density_svm <- visualize_time_series('bstepN_SVM_poly')

# Random Forest (rf)
best_rf <- make_best('bstep_RF')
best_rf_fit <- make_best_fit('bstep_RF')
best_baseline_fit_rf <- make_best_fit_baseline('bstep_RF')
plot_test_best_rf <- visualize_best_fit_test('bstep_RF')
plot_EvO_density_rf <- visualize_expected_v_observed('bstep_RF')
plot_timeseries_density_rf <- visualize_time_series('bstep_RF')
...
names(my_figures) <- str_replace_all(my_figure_names, 'plot_', '33_density_00mo_')
