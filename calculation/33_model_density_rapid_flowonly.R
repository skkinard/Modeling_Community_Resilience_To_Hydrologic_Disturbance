...
apriori <- c('annualrain', 'ln_q2wk_med', 'ln_q2wk_sd', "ln_q2wk_max",
...
# Random Forest (rf)
best_rf <- make_best('apr_RF')
best_rf_fit <- make_best_fit('apr_RF')
best_baseline_fit_rf <- make_best_fit_baseline('apr_RF')
plot_test_best_rf <- visualize_best_fit_test('apr_RF')
plot_EvO_density_rf <- visualize_expected_v_observed('apr_RF')
plot_timeseries_density_rf <- visualize_time_series('apr_RF')

# Boosted Trees Ensemble (xgb)
best_xgb <- make_best('apr_XGB')
best_xgb_fit <- make_best_fit('apr_XGB')
best_baseline_fit_xgb <- make_best_fit_baseline('apr_XGB')
plot_test_best_xgb <- visualize_best_fit_test('apr_XGB')
plot_EvO_density_xgb <- visualize_expected_v_observed('apr_XGB')
plot_timeseries_density_xgb <- visualize_time_series('apr_XGB')
